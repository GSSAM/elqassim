    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-100 px-4">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 border border-white">
          ...
          <div className="bg-red-50 border-r-4 border-red-500 p-4 mb-6 rounded-lg text-red-700 text-sm flex justify-between items-center">
            ...
            {setupMode && (
              <button 
                ...
                className="bg-red-600 text-white px-3 py-1 rounded-md font-bold text-xs hover:bg-red-700 transition"
              >
                تهيئة الآن
              </button>
            )}
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <button
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl transition-all shadow-xl shadow-blue-200 active:scale-95 flex justify-center items-center gap-2"
          >
            {loading ? (
